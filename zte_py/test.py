...
loop_n = 10
# {4: 128, 6: 640, 8: 10304, 10: 108800, 12: 1292928}
...
for key in range(n_a):
    print(key)
    elapsed = (time.time() - start_time)
    print("Time used:", elapsed)
    deep_search(map_record,[key],result_n,1, visited)
...
#     #         # print(result_n)
#     #         # print(temp)
#     result_n[i] = len(result[i])/2
    # sum_len = sum_len + len(result[i])
# print(result)
for i,num in result_n.items():
    result_n[i] = int(num/2)
print(result_n)
#
